...
export default function Hero1({
    ...
    return (
        ...
        >
            {/* ── Background Grid Image with #0B2A4A brand styling ── */}
            <motion.div
                initial="hidden"
                animate="visible"
            ...
            >
                <img
                    ...
                    alt="Architectural grid structure background"
                    className="absolute inset-0 h-full w-full object-cover object-bottom-left opacity-80 filter grayscale brightness-90 contrast-125 mix-blend-screen"
                />
                ...
                />
                {/* Radial fade — top & right edges blend into the dark #05070A bg */}
                <div
                    className="absolute inset-0"
                    style={{
                        background:
                            "radial-gradient(ellipse 80% 70% at 20% 80%, transparent 35%, #05070A 85%)",
                    }}
                />
            </motion.div>
            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    <motion.div
                        ...
                        className="fixed inset-0 bg-[#05070A]/98 backdrop-blur-md z-40 flex flex-col justify-between px-6 py-24 md:hidden"
                    >
                        {/* Nav links stack */}
